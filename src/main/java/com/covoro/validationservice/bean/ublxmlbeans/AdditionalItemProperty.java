...
@XmlRootElement(name = "AdditionalItemProperty", namespace = Namespaces.COMMON_AGGREGATE_COMPONENT_2)
public class AdditionalItemProperty {
    ...
    @JacksonXmlProperty(localName = "Value", namespace = Namespaces.COMMON_BASIC_COMPONENT_2)
    @XmlElement(name = "Value", namespace = Namespaces.COMMON_BASIC_COMPONENT_2)
