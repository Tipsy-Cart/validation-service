...
@XmlRootElement(name = "OrderLineReference", namespace = Namespaces.COMMON_AGGREGATE_COMPONENT_2)
public class OrderLineReference {

    @JacksonXmlProperty(localName = "LineID", namespace = Namespaces.COMMON_BASIC_COMPONENT_2)
    @XmlElement(name = "LineID", namespace = Namespaces.COMMON_BASIC_COMPONENT_2)
