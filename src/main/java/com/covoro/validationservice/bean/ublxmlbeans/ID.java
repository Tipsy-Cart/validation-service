...
public class ID {
    ...
    @JacksonXmlProperty(localName = "schemeID", isAttribute = true, namespace = Namespaces.COMMON_BASIC_COMPONENT_2)
    @XmlAttribute(name = "schemeID", namespace = Namespaces.COMMON_BASIC_COMPONENT_2)
